...
export default function NewBlogPostPage() {
  ...
  const [tagsInput, setTagsInput] = useState<string>('Next.js, React, Architecture');
  ...
  return (
    <DashboardLayout title="Create Blog Post" subtitle="Write, auto-format, and publish your technical article">
