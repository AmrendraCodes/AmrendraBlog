...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-[#020617] text-slate-900 dark:text-white selection:bg-blue-100 font-sans overflow-x-hidden">
      {/* Hero Section */}
      <section className="pt-16 pb-10 md:pt-24 md:pb-16 px-4 sm:px-6 max-w-5xl mx-auto text-center border-b border-slate-50 dark:border-slate-800">
        ...
        <h1 className="text-3xl sm:text-5xl md:text-7xl font-black tracking-tighter mb-6 md:mb-8 leading-[1.1] min-h-[3em] sm:min-h-[2em] md:min-h-[1.2em] flex flex-wrap justify-center items-center">
          <span className="text-slate-900 dark:text-white inline-block mr-3">{displayText.substring(0, 8)}</span>
      ...
      <section className="py-12 md:py-20 px-4 sm:px-6 max-w-3xl mx-auto">
        <h2 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white mb-6 md:mb-10 flex items-center gap-3 sm:gap-4">
        ...
        <div className="space-y-6 md:space-y-8 text-base sm:text-lg md:text-xl text-slate-600 dark:text-slate-300 leading-relaxed font-normal">
          ...
          <p>
            Now I'm combining my writing background with <em className="text-slate-900 dark:text-white font-semibold not-italic">React and Next.js</em> to create things that are fast, intuitive, and actually make sense to real people.
          </p>
        </div>
      </section>

      {/* Professional Timeline */}
      <section className="py-12 md:py-20 px-4 sm:px-6 bg-white dark:bg-[#020617] border-t border-slate-50 dark:border-slate-800">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-10 md:mb-16 text-center">Work Experience</h2>
          ...
          <div className="relative space-y-8 md:space-y-12 before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-blue-200 before:to-transparent">
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
              <div className="flex items-center justify-center w-10 h-10 rounded-full border-4 border-white bg-blue-600 text-white shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
                <div className="w-2 h-2 bg-white dark:bg-[#020617] rounded-full"></div>
              </div>
              <div className="w-[calc(100%-3.5rem)] md:w-[45%] p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl bg-slate-50 dark:bg-[#0f172a] border border-slate-100 dark:border-slate-800 shadow-sm group-hover:shadow-md transition-shadow">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 mb-2">
                  <div className="font-black text-slate-900 dark:text-white text-base sm:text-lg leading-tight uppercase tracking-tight">SEO Executive</div>
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
              ...
              <div className="w-[calc(100%-3.5rem)] md:w-[45%] p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl bg-slate-50 dark:bg-[#0f172a] border border-slate-100 dark:border-slate-800 shadow-sm group-hover:shadow-md transition-shadow">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 mb-2">
                  <div className="font-black text-slate-900 dark:text-white text-base sm:text-lg leading-tight uppercase tracking-tight">Technical Content Writer</div>
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
              <div className="flex items-center justify-center w-10 h-10 rounded-full border-4 border-white bg-blue-600 text-white shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
                <div className="w-2 h-2 bg-white dark:bg-[#020617] rounded-full animate-pulse"></div>
              </div>
      ...
      <section className="py-12 md:py-20 px-4 sm:px-6 bg-slate-50 dark:bg-[#0f172a] border-y border-slate-100 dark:border-slate-800">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-3 md:mb-4 px-2">Why I started this blog</h2>
            <p className="text-slate-500 text-base sm:text-lg px-4">My personal mission for this digital space.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-white dark:bg-[#020617] p-8 md:p-10 rounded-3xl md:rounded-[2.5rem] shadow-sm border border-slate-200 dark:border-slate-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <h3 className="font-bold text-lg md:text-xl mb-3 md:mb-4 text-slate-900 dark:text-white">Learn in Public</h3>
            ...
            <div className="bg-white dark:bg-[#020617] p-8 md:p-10 rounded-3xl md:rounded-[2.5rem] shadow-sm border border-slate-200 dark:border-slate-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <h3 className="font-bold text-lg md:text-xl mb-3 md:mb-4 text-slate-900 dark:text-white">Live Portfolio</h3>
              <p className="text-slate-600 dark:text-slate-300 text-sm md:text-base leading-relaxed">
            ...
            <div className="bg-white dark:bg-[#020617] p-8 md:p-10 rounded-3xl md:rounded-[2.5rem] shadow-sm border border-slate-200 dark:border-slate-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 sm:col-span-2 lg:col-span-1">
              ...
              <h3 className="font-bold text-lg md:text-xl mb-3 md:mb-4 text-slate-900 dark:text-white">Pay It Forward</h3>
              <p className="text-slate-600 dark:text-slate-300 text-sm md:text-base leading-relaxed">
      ...
      <section className="py-12 md:py-20 px-4 sm:px-6 max-w-3xl mx-auto">
        <h2 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white mb-10 text-center">What to expect here</h2>
        <div className="space-y-4 md:space-y-6">
          {[
            ...
            <div key={i} className="group flex items-start gap-4 sm:gap-6 p-5 md:p-6 rounded-2xl md:rounded-3xl hover:bg-slate-50 dark:bg-[#0f172a] transition-all border border-transparent hover:border-slate-100 dark:border-slate-800">
              ...
              <div>
                <h4 className="font-bold text-lg md:text-xl text-slate-900 dark:text-white mb-1 leading-tight">{item.title}</h4>
      ...
      <section className="py-12 px-4 sm:px-6 max-w-6xl mx-auto mb-10">
        <div className="bg-blue-50 border border-blue-100 rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-12 md:p-20 text-center relative overflow-hidden shadow-sm">
          ...
          <div className="relative z-10">
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-6 md:mb-8 tracking-tight">Building the Future</h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
              ...
              <Link
                href="/blog"
                className="w-full sm:w-auto px-10 md:px-12 py-4 md:py-5 bg-white dark:bg-[#020617] text-slate-900 dark:text-white border border-slate-200 dark:border-slate-800 rounded-full font-black text-base md:text-lg hover:bg-slate-50 dark:bg-[#0f172a] transition-all shadow-md hover:scale-105"
              >
                Read My Blog
              </Link>
            </div>
