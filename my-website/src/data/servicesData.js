...
export const SERVICES_DATA = [
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    metaTitle: "Custom Web Development — Next.js, React & Cloud Deployment | Code with Amrendra",
    metaDescription: "I build fast, responsive websites and web apps using Next.js and React — from UI design through AWS deployment. See the FinTrack and ShopEase case studies.",
    iconName: "Code2",
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    metaTitle: "AI Agent Development & Workflow Automation | Code with Amrendra",
    metaDescription: "I build custom AI chatbots, LLM integrations, and workflow automations for small-to-mid businesses. Built by one developer, not a sales team. See the MediCare case study.",
    iconName: "Sparkles",
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    metaTitle: "SEO & Technical Content Writing for SaaS & Dev Companies | Code with Amrendra",
    metaDescription: "Technical content written by a developer, not a content mill. SEO strategy, blog content for SaaS companies, and technical writing that ranks — backed by a live portfolio at codewithamrendra.in/resources/blog.",
    iconName: "FileSearch",
