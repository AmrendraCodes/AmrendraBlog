        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {benefits.map((benefit, idx) => (
            <AnimatedSection
              ...
              direction="up"
              delay={idx * 0.1}
              className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-2xl p-6 relative flex flex-col justify-between group hover:border-[#6366F1]/40 hover:shadow-[var(--shadow-card)] transition-all duration-300"
            >
              <div>
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#6366F1]/20 to-[#a855f7]/20 border border-[#6366F1]/30 text-[#6366F1] font-bold text-sm flex items-center justify-center mb-5">
                  0{idx + 1}
                </div>
                <h3 className="text-lg font-bold text-[var(--text-heading)] mb-3 group-hover:text-[#6366F1] transition-colors">
                  {benefit.title}
                </h3>
