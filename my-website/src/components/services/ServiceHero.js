...
export default function ServiceHero({ service }) {
  return (
    <section className="relative pt-32 pb-16 lg:pt-40 lg:pb-24 overflow-hidden border-b border-[var(--card-border)] bg-gradient-to-b from-[var(--background)] via-[var(--card-bg)] to-[var(--background)]">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-gradient-to-tr from-[#6366F1]/15 to-[#a855f7]/15 rounded-full blur-[100px] pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        ...
        <AnimatedSection direction="down" delay={0.05} className="mb-8">
          <nav aria-label="Breadcrumb" className="inline-flex items-center gap-2 text-xs sm:text-sm text-[var(--text-muted)] bg-[var(--card-bg)] border border-[var(--card-border)] px-4 py-2 rounded-full shadow-sm">
            ...
            <Link href="/services" className="hover:text-[#6366F1] transition-colors">
              Services
            </Link>
            <ChevronRight size={14} className="opacity-50" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <AnimatedSection direction="up" delay={0.1} className="lg:col-span-7 flex flex-col items-start">
            ...
            <div className="flex flex-wrap items-center gap-4 w-full sm:w-auto">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2.5 bg-gradient-to-br from-[#6366F1] to-[#a855f7] text-white font-bold text-base py-3.5 px-8 rounded-full shadow-[var(--shadow-glow)] transition-all duration-300 hover:scale-105 active:scale-95 w-full sm:w-auto"
              >
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 bg-[var(--card-bg)] border border-[var(--card-border)] text-[var(--text-heading)] font-semibold text-base py-3.5 px-7 rounded-full hover:border-[#6366F1] hover:text-[#6366F1] transition-all duration-300 w-full sm:w-auto"
              >
          ...
          <AnimatedSection direction="left" delay={0.2} className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none bg-gradient-to-br from-[var(--card-bg)] to-[var(--background)] border border-[var(--card-border)] rounded-3xl p-8 shadow-[var(--shadow-3d)] overflow-hidden">
              ...
              <div className="flex items-center justify-between border-b border-[var(--card-border)] pb-6 mb-6">
                ...
                <div className="w-10 h-10 rounded-xl bg-[#6366F1]/10 border border-[#6366F1]/20 flex items-center justify-center text-[#6366F1] font-mono font-bold text-sm">
                  {service.indexNumber}
                </div>
              </div>
