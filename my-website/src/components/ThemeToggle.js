...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}
      className="flex items-center justify-center w-11 h-11 min-w-[2.75rem] min-h-[2.75rem] rounded-full bg-slate-100/80 dark:bg-[#1A1B1E]/80 border border-slate-200/50 dark:border-[#2A2B2E]/50 text-slate-600 dark:text-slate-400 hover:bg-slate-200/80 dark:hover:bg-[#2A2B2E]/80 hover:text-[#10B981] dark:hover:text-[#34D399] transition-all duration-300"
      aria-label="Toggle Dark Mode"
    >
