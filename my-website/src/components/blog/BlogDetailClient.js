  ...
  return (
    <>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_minmax(0,760px)_minmax(0,1fr)] xl:justify-center gap-6 xl:gap-8 items-start">
          
          {/* Desktop TOC — Sticky Sidebar on the Left */}
          <aside className="hidden xl:block w-full min-w-0 shrink-0 sticky top-28 space-y-6" id="toc-desktop">
          ...
          <div className="hidden xl:block w-full min-w-0 pointer-events-none" aria-hidden="true" />
        </div>
      </div>
    </>
  );
