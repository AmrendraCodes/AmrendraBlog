      ...
      >
            ...
            return (
              <div key={index}>
                <Link
                  ...
                  className={`group block p-6 rounded-2xl border border-[var(--card-border)] bg-gradient-to-br ${category.gradient}  hover:border-[#F59E0B]/40 transition-colors duration-200 cursor-pointer no-underline h-full`}
                >
                  {/* Icon + Badge Row */}
        ...
        <div className="text-center">
          ...
          >
            ...
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="transition-transform duration-200 "><path d="M5 12h14M12 5l7 7-7 7"/></svg>
          </Link>
        </div>
      </div>
    </section>
