            ...
            <li key={heading.id} className="relative">
              {isActive && (
                <motion.div
                  ...
                  className="absolute left-[-1px] top-0 bottom-0 w-0.5 bg-[#F59E0B]"
                  initial={false}
              ...
              <a
                ...
                className={`
                  ...
                  ${
                    isActive
                      ? "text-[#D97706] dark:text-[#F59E0B] bg-[#F59E0B]/10 font-bold"
    ...
    return (
      <div className="w-full mb-8 bg-white/5 backdrop-blur-md border border-[var(--card-border)]/50 rounded-2xl shadow-sm" id="toc-mobile">
        ...
        >
          ...
          >
            <ChevronDown size={18} className="text-[#F59E0B]" />
          </motion.div>
        </button>
