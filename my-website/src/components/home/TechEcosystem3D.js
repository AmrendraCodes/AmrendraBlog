...
export default function TechEcosystem3D() {
  ...
  return (
    <div className="w-full relative py-6 flex flex-col items-center justify-center">
      ...
      <div className="relative w-full max-w-4xl aspect-[800/520] min-h-[300px] sm:min-h-[460px] rounded-3xl bg-[#0A0F0C]/95 border border-[#1E2E25] p-2 sm:p-6 shadow-2xl flex items-center justify-center overflow-hidden backdrop-blur-xl">
          ...
          {technologies.map((tech) => {
            ...
            return (
              <line
                ...
                x2={`${tech.x}%`}
                y2={`${tech.y}%`}
                stroke={isHovered ? '#10B981' : 'rgba(16, 185, 129, 0.3)'}
        ...
        >
          <div className="w-12 h-12 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-[#10B981] to-[#059669] text-white flex items-center justify-center shadow-[0_0_40px_rgba(16,185,129,0.6)] border-2 border-white/20 animate-[pulse_3s_ease-in-out_infinite] group-hover:scale-110 transition-transform">
        ...
        >
          <span className="text-[9px] sm:text-xs font-extrabold uppercase tracking-widest text-white bg-[#060907]/95 px-2.5 py-1 sm:px-4 sm:py-1.5 rounded-full border border-[#10B981]/50 shadow-[0_0_15px_rgba(16,185,129,0.35)] whitespace-nowrap">
            CWA Core Engine
          </span>
        </div>
            ...
            >
              ...
              <div
                className={`w-8 h-8 sm:w-13 sm:h-13 rounded-xl sm:rounded-2xl flex items-center justify-center border transition-all duration-300 backdrop-blur-md ${
                  isHovered
                    ? 'bg-[#10B981] text-[#FFFFFF] border-[#34D399] shadow-[0_0_25px_rgba(16,185,129,0.6)] scale-110'
        ...
        <AnimatePresence mode="wait">
          {activeItem ? (
            <motion.div
              ...
              exit={{ opacity: 0, y: -8 }}
              className="p-3 sm:p-4 rounded-2xl bg-[#0A0F0C] border border-[#10B981]/50 text-xs sm:text-sm text-[#F3F4F6] font-medium shadow-xl backdrop-blur-md flex items-center justify-center gap-2 text-left"
            >
              <Zap size={16} className="text-[#34D399] shrink-0" />
              <div>
            ...
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="text-xs sm:text-sm text-[#9CA3AF] italic flex items-center justify-center gap-2 py-2"
            >
